...
|| Task                                                                          | Status  | Impact | Effort | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|| ------------------------------------------------------------------------------ | ------- | ------ | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|| samber-do-auditlog: implement `DetailedHealthRecorder` (first implementor)              | BLOCKED | Medium | 1h     | Premise corrected 2026-09-22: auditlog times builds + shutdowns (`FirstBuildDurationMs`/`ShutdownDurationMs`), NOT health checks — `Plugin.RecordHealthCheckWithContext` wraps `injector.HealthCheckWithContext` (`map[string]error`, no timing channel), and do exposes no non-generic per-service check API to time. Unblocker = upstream duration field (see the #318 draft in Owner Actions); then auditlog maps it 1:1. |
