...
6. **Routings are pointers and can dangle**: "→ TODO_LIST"/"→ ROADMAP" markers
   ...
   ships, sweep _both_ directions: the target file AND the historical routing.
